...
schema = DataFrameSchema({
    ...
    'Data de lançamento': Column(pa.Float, nullable=True, coerce=True),
    'Centro de lucro': Column(pa.Float, nullable=True, coerce=True),
    ...
    'Client description': Column(pa.Float, nullable=True, coerce=True),
    'Supplier description': Column(pa.Float, nullable=True, coerce=True),
    'IATA Code': Column(pa.Float, nullable=True, coerce=True),
    'Unique Code': Column(pa.String, nullable=True, coerce=True),
    'Asset': Column(pa.String, nullable=True, coerce=True),
    'Exercicio': Column(pa.Float, nullable=True, coerce=True),
    'Versão': Column(pa.String, nullable=True, coerce=True),
},
    strict=True,
    coerce=True,
)
