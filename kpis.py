...
def finance_provisions_kpis(file):
    ...
    kpis["provisions_kpi"] = [["amountValue"], [format_amount(df['amountValue'].sum().sort_values(by='amountSum', ascending=False))]]
...
kpis_function_tab : Dict[str, Callable[[str], dict]] = {
    "DEPOSITS": finance_deposits_kpis, # OK
    "GUARANTEES": finance_guarantees_kpis, # OK
    "CAPEX_FORECAST": finance_capex_forecast_kpis, # CHECK CPX FILES ERROR
    "RECEIVABLES" : finance_receivables_kpis,# OK
    "CUSTOMER_REVENUES": finance_customer_kpis,
    "PROCUREMENTS": finance_procurement_kpis, # OK
    "PROVISIONS": finance_provisions_kpis, # AERODOM TO TEST
    "CAPEX": finance_capex_kpis, # OK
    "GENERAL_LEDGER": finance_general_ledger_kpis # OK
    # "CAPEX_DETAILED":,
